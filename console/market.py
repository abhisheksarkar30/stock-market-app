"""
    This module serves to be the parent level command line interpreter for the Stock Market App(market).
    Each command of this tool need to be served by classes in separate specific modules.

        Usage :  market [-h] command [<args>]
...
class Market:
    usage = "usage: market [-h] command [<args>]"
    naError = usage + "\n market: error: the following arguments are required: command"
    uError = naError + "\n market: error: unrecognized arguments: "
    helpDetail = usage
    switcher = {}
